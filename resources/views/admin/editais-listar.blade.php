    ...
    <div class="page-title">
        ...
        <div class="title_right">
            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                <form action="{!! route('editais-buscar') !!}" method="post">
                    {!! csrf_field() !!}
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class=" x_title">
                    ...
                    <h3>Lista de editais registradas</h3>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    @endif
                        ...
                        <table class="table table-striped responsive-utilities jambo_table bulk_action">
                            ...
                            <tr class="even pointer">
                                <td class="a-center ">
                                    <input type="checkbox" value="{!! $edital->id !!}" class="flat" name="table_records">
                                </td>
                                <td class=" ">{!! $edital->title !!}</td>
                                <td class=" ">{!! $edital->created_at !!}</td>
                                <td class=" ">{!! $edital->updated_at !!}</td>



                                <td class=" last"><a href="{!! route("editais-mostra",$edital->id) !!}" class="btn btn-xs btn-info"><i class="fa fa-pencil"></i> </a><a href="{!! route('editais-deleta',$edital->id) !!}" onclick="return confirm('Você deseja mesmo excluir este download?')" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                           @endforeach
                            </tbody>
