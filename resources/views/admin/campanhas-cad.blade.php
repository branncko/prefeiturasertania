        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    @endif
                    <form action="{!! route('campanha-salva') !!}" id="demo-form" data-parsley-validate class="form-horizontal " enctype="multipart/form-data" method="post">
{{ csrf_field()  }}
                        <div class="form-group">
                            <label class="control-label col-md-2 col-sm-2 col-xs-12">Nome</label>
                            <div class="col-md-10 col-sm-10 col-xs-12">
                                <input type="text" id="titulo" class="form-control" name="titulo" required  value="{!! old("title") !!}"/>
                            </div>
                        </div>
