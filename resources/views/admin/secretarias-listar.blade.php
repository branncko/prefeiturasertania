    ...
    <div class="page-title">
        ...
        {{--<div class="title_right">--}}
            {{--<div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">--}}
                {{--<form action="{!! route('secretarias-buscar') !!}" method="post">--}}
                    {{--{!! csrf_field() !!}--}}
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class=" x_title">
                    ...
                    <h3>Lista de secretarias registrados</h3>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    @endif
                        ...
                        <table class="table table-striped responsive-utilities jambo_table bulk_action">
                            ...
                            <tr class="even pointer">
                                <td class="a-center ">
                                    <input type="checkbox" value="{!! $secretaria->id !!}" class="flat" name="table_records">
                                </td>
                                <td class=" ">{!! $secretaria->titulo !!}</td>
                                <td class=" ">{!! $secretaria->created_at !!}</td>
                                <td class=" ">{!! $secretaria->updated_at !!}</td>



                                <td class=" last"><a href="{!! route("secretarias-mostra",$secretaria->id) !!}" class="btn btn-xs btn-info"><i class="fa fa-pencil"></i> </a><a href="{!! route('secretarias-deleta',$secretaria->id) !!}" onclick="return confirm('Você deseja mesmo excluir esta secretaria?')" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                           @endforeach
                            </tbody>
