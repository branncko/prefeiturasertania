        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    @endif
                        {!! Form::model($secretaria, ['route' => ['secretarias-update', $secretaria->id],'id'=>'demo-form','data-parsley-validate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".select2_single").select2({
                ...
                placeholder: "Máximo de 1 secretaria",
                allowClear: true
            });
